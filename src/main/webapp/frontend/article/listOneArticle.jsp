        ...
        <div class="displayBox">
            ...
            <div class="author_block row">
                <div class="author col-9">
                    ...
                    <c:if test="${articleVO.article_identityVO.article_pic==null}">
                        <img class="photo"
                             src="<%=request.getContextPath() %>/frontend/article/img/photo.png">&ensp;<span id="autBlock">作者</span>&ensp;<span class="author">${articleVO.memVO.mem_account}</span>
                    </c:if>
                </div>
            ...
            <div class="row edit_block">
                <div class="like_button col-3">
                    ...
                    <form method=post id="likeForm" class="lhbtn">
                        <img src="<%=request.getContextPath() %>/frontend/article/img/good.png" width="50px"
                             height="50px"
                             class="good" id="like">
                        <input type="hidden" name="mem_id" value="${memVO.mem_id}">
                        <input type="hidden" name="article_id" value="${param.article_id}">
                    ...
                    <form method=post id="hateForm" class="lhbtn">
                        <img src="<%=request.getContextPath() %>/frontend/article/img/bad.png" width="50px"
                             height="50px"
                             class="bad" id="hate">
                        <input type="hidden" name="mem_id" value="${memVO.mem_id}">
                        <input type="hidden" name="article_id" value="${param.article_id}">
                ...
                <div class="report">
                    <form method='post' action='/CGA104G1/Article_reportServlet'>
                        ...
                        <input type='hidden' class='form-control insert' id="reportReason" name='afrep_content'
                               value='${param.com_content}'
                               placeholder='請輸入檢舉原因' required>&ensp;&ensp;&ensp;
                        <button type='submit' class='btn btn-danger' id="reportSubmit" style="visibility: hidden">
                            送出檢舉
                        </button>
                    </form>
                </div>
